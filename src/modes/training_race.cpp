...
//-----------------------------------------------------------------------------
TrainingRace::TrainingRace() : LinearWorld()
{
...
//-----------------------------------------------------------------------------
void TrainingRace::getDefaultCollectibles(int *collectible_type, int *amount)
{
 ...
 */
bool TrainingRace::haveBonusBoxes()
{
 ...
 */
void TrainingRace::endRaceEarly()
{
