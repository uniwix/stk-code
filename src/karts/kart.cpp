...
void Kart::setRaceResult()
{
    ...
    else if (RaceManager::get()->getMinorMode() == RaceManager::MINOR_MODE_NAI || RaceManager::get()->getMinorMode() == RaceManager::MINOR_MODE_TAI || RaceManager::get()->getMinorMode() == RaceManager::MINOR_MODE_QAI)
    {
